$(function () {
  ...
  $(".sec_01 .container .list-items").on(
    "inview",
    function (e, isInview) {
      if (isInview) {
        $(this).css("opacity", 1);
  ...
  $(".sec_02 .container .list-benefits").on(
    "inview",
    function (e, isInview) {
      if (isInview) {
        $(this).css("opacity", 1);
        ...
        .each(function (index) {
          ...
          $(this).on("inview", function (e, isInview) {
            if (isInview && !$(this).hasClass("li-animated")) {
              console.log("inview triggered for li item", index);
              $(this).animate({ opacity: 1 }, 400);
  ...
  // Float Social
  // $("html").on("inview", function(e, isInview) {
  //   if(isInview) {
  //     $(this).find(".float-social.is-scroll").css("animation-delay", '1s').addClass('animate__animated animate__fadeInRight')
  //     $(this).find(".float-social").addClass('animate__animated animate__fadeOutRight')
